...
import type { ModelId } from "@/services/analysis/models";
import type { TopicSlug } from "@/services/analysis/topics";
import type { Severity } from "@/services/run/result";
 ...
 *
 * It lives here and not in services/analysis/models.ts because cost is a property of
