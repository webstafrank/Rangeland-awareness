...
import { run, runId } from "@/services/run";
import type { RunConfig } from "@/services/run/config";
import { AFFECTED_SHARE_BY_SEVERITY, SEVERITY_ORDER } from "@/services/run/constants";
import { formulaValuesFor } from "@/services/run/engine";
import { runIdFor } from "@/services/run/hash";
import { classify, indicatorFor, spanOf } from "@/services/run/indicators";
import type { IndicatorSpec } from "@/services/run/result";
import {
  ALL_AREAS,
  BASE_CONFIG,
  COMPARISON_CONFIG,
