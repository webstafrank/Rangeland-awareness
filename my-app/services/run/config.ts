 ...
 * superset of `AnalysisRequest` in services/analysis/request.ts — that type is the
...
import { getAnalysisType, isAnalysisTypeId, isModelId } from "@/services/analysis/models";
import type { AnalysisTypeId, ModelId } from "@/services/analysis/models";
import { isTopicSlug } from "@/services/analysis/topics";
import type { TopicSlug } from "@/services/analysis/topics";
import type { RequestArea } from "@/services/analysis/request";
import { formulasForTopic, isFormulaId } from "@/services/analysis/formulas";
import type { FormulaId } from "@/services/analysis/formulas";
import { inclusiveDayCount, parseIsoDate } from "@/services/run/dates";
 ...
 * services/analysis/request.ts, deliberately: the run page and the topic page render
