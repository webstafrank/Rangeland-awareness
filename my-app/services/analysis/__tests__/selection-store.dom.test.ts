...
import type { AreaOfInterest, DraftArea } from "@/services/analysis/selection";
...
type Store = typeof import("@/services/analysis/selection-store");

async function freshStore(): Promise<Store> {
  vi.resetModules();
  sessionStorage.clear();
  return import("@/services/analysis/selection-store");
}
...
describe("two topics", () => {
  ...
  it("survives a reload, which is a fresh module registry", async () => {
    ...
    vi.resetModules();
    const reloaded: Store = await import("@/services/analysis/selection-store");
