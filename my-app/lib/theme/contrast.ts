 ...
 *
 * The dark theme leans on translucent panel fills (cobalt at low alpha over the
 * midnight ground), and a ratio computed against the fill's own hex would be a
 * lie about the rendered pixel.
 */
