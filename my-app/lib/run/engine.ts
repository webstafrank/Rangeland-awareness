...
import { monthCount, previousYearWindow } from "@/lib/run/dates";
import { areaSeedKey, seedFor } from "@/lib/run/hash";
import { classify, intoDomain, spanOf } from "@/lib/run/indicators";
import type { AreaResult, Estimate, IndicatorSpec } from "@/lib/run/result";
import { clamp, mulberry32, roundTo, signedBell, uniform } from "@/lib/run/rng";
 ...
 * here and not in lib/analysis/formulas.ts. That file says what an index is and
