...
import { FLOOD_METHOD } from "@/lib/criteria/flood";
import { LANDSLIDE_METHOD } from "@/lib/criteria/landslide";
import type { Criterion, TopicMethod } from "@/lib/criteria/types";

export * from "@/lib/criteria/types";
export { FLOOD_CRITERIA, FLOOD_DEFAULT_WEIGHTS, FLOOD_METHOD } from "@/lib/criteria/flood";
export { LANDSLIDE_CRITERIA, LANDSLIDE_METHOD } from "@/lib/criteria/landslide";
